...
In its early days, the network[Bitcoin](https://coinacademy.fr/bitcoin-btc-fondamental/)has experienced some disruptions and incidents, but it has never been completely broken down. Some disruptions were caused by[denial of service attacks](https://fr.wikipedia.org/wiki/Attaque_par_d%C3%A9ni_de_service)(DDoS) on the nodes hosting the blockchain [Bitcoin](###), but these attacks were also generally repelled without disrupting network operation.
