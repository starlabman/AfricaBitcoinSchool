...
Bitcoin works thanks to a combination of technologies: encryption algorithms (cryptography), a decentralized network and a consensus mechanism: the [Proof of Work](/guide-proof-of-work/).

The operating logic of Bitcoin is simple: [to secure](/guide-securite-portefeuille-crypto-nft/)Bitcoin (the protocol) by rewarding the actors who make it work in bitcoins (the currency).
